...
superduper_app = SuperDuper(root)
...
super_duper_button = Button(master = root, image = super_duper_icon, command = lambda: superduper_app.launch_superduper()).grid(row=1, column=1, padx=3, pady=1)
